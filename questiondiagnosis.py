...
doc_dataset = pd.read_csv('doctordataset.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Ayush Mishra", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
